                        ...
                        case '2':
                            {
                                ...
                                Console.WriteLine();
                                if (obj.delNode(rollNo) == false) Console.WriteLine("Record not found");
                                else Console.WriteLine("Record with roll number" + rollNo + " deleted \n");
                            }
                            break;
                        case '3':
                            {
                        ...
                        case '5':
                            {
                                ...
                                Node prev, curr;
                                prev = curr = null;
                                Console.Write("\nEnter the roll numbber of the student whose record you want to search: ");
